...
public class NewGame extends JFrame {
	...
	public NewGame() {
		...
		setType(Type.POPUP);
		setTitle("New Game");
		setIconImage(Toolkit.getDefaultToolkit().getImage(NewGame.class.getResource("/assets/favicon.png")));
		...
		lblNewGameData.setIcon(new ImageIcon(NewGame.class.getResource("/assets/favicon.png")));
		...
		setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{startQuestion, yesAns, noAns, btnSubmit, btnCancel}));
	}
}
