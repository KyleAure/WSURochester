...
public class NewQuestion extends JFrame {
	 ...
	 */
	public NewQuestion() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NewQuestion.class.getResource("/assets/favicon.png")));
		...
		lblNewQuestionTitle.setIcon(new ImageIcon(NewQuestion.class.getResource("/assets/favicon.png")));
		...
		setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{correctAns, newQuestion, btnSubmit}));
	}
}
